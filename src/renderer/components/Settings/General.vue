            ...
            <div class="option-item">
                <div class="flex">
                    ...
                    @click="removeMusicFolder">
                        <p class="button-p">{{ appMusicFolder ? appMusicFolder : 'None' }}</p>
                    ...
                    @click="handle_music_sync">
                        <p class="button-p">Sync</p>
                        <svg :class="{spinner: syncing}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="isolation:isolate" viewBox="1316.56 321.171 38.1 36.125" width="12" height="12">
...
<style lang="stylus" scoped>
    ...
    .spinner
        animation round 1.2s ease infinite
