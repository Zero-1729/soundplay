<template>
    <div class="main-toolset-container-alt">
        ...
        <div class="item equiliser-icon" :class="{activeIcon: activeOption == 'equiliser'}">
            <svg class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="isolation:isolate" viewBox="10.957 462 15.948 16.379" width="15.948" height="16.379" @click="updateActiveOption('equiliser')">
