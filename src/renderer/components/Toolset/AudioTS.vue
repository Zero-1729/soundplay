<template>
    <div class="main-toolset-container">
        <div class="item musc-icon" :class="{activeIcon: currentCriteria == 'music'}">
            ...
            <svg class="icon" :class="{greyedIcon: playingCriteria == 'music' && currentCriteria != 'music'}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="isolation:isolate" viewBox="12.531 148.128 13 14.303" width="13" height="14.303" @click="updateCriteria('music')">
        ...
        <div class="item album-icon" :class="{activeIcon: currentCriteria == 'album'}">
            ...
            <svg class="icon" :class="{greyedIcon: playingCriteria == 'album' && currentCriteria != 'album'}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="isolation:isolate" viewBox="512 500.753 17 23.247" width="17" height="22.247" @click="updateCriteria('album')">
        ...
        <div class="item artist-icon" id="larger" :class="{activeIcon: currentCriteria == 'artist'}">
            ...
            <svg class="icon" :class="{greyedIcon: playingCriteria == 'artist' && currentCriteria != 'artist'}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="isolation:isolate" viewBox="546 501.5 11 24.247" width="13" height="24" @click="updateCriteria('artist')">
        ...
        <div class="item artist-icon" id="larger" :class="{activeIcon: currentCriteria == 'genre'}">
            ...
            <svg class="icon" :class="{greyedIcon: playingCriteria == 'genre' && currentCriteria != 'genre'}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="isolation:isolate" viewBox="11.313 193.338 15 15" width="15" height="15" @click="updateCriteria('genre')">
        ...
        <div class="item playlist-icon" :class="{activeIcon: currentCriteria == 'playlist'}">
            ...
            <svg class="icon" :class="{greyedIcon: playingCriteria == 'playlist' && currentCriteria != 'playlist'}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="isolation:isolate" viewBox="10.813 391.338 16 14.554" width="16" height="14.554" @click="updateCriteria('playlist')">
